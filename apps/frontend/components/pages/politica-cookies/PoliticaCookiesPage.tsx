    ...
    <div className="min-h-screen bg-linear-to-b from-white to-gray-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-teal-50 text-[#2c8184] rounded-2xl mb-4">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-xl p-6 sm:p-8 mb-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex-1">
            <h2 className="text-xl font-bold text-gray-900 mb-2 flex items-center gap-2">
              <Sliders className="w-5 h-5 text-[#2c8184]" />
          ...
          <button
            ...
            className="w-full md:w-auto px-6 py-3 bg-[#2c8184] hover:bg-[#1e6063] text-white font-semibold rounded-xl shadow-md transition-all duration-200 hover:-translate-y-0.5 flex items-center justify-center gap-2 cursor-pointer"
          >
          ...
          <section className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-100 shadow-sm">
            ...
            <ul className="space-y-2.5 text-sm text-gray-600">
              <li className="flex items-center gap-2">
                <ExternalLink className="w-4 h-4 text-[#2c8184] shrink-0" />
                <a
                  href="https://support.google.com/chrome/answer/95647?hl=es"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#2c8184] hover:underline font-medium flex items-center gap-1"
                >
                  Google Chrome
                </a>
              </li>
