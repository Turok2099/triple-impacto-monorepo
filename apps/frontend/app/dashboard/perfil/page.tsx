    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      <div className="max-w-2xl mx-auto">
        ...
        <section className="flex flex-col items-center py-6">
          ...
          <p className="mt-3 text-[#2c8184] text-xs font-bold uppercase tracking-wider">
            Cambiar Foto
          </p>
        </section>
        ...
        <section className="px-6 mb-8">
          <div className={`border rounded-2xl p-4 flex items-center justify-between ${
            user?.role === 'admin' ? 'bg-purple-100/50 border-purple-200' : 'bg-[#2c8184]/5 border-[#2c8184]/10'
          }`}>
            <div className="flex items-center gap-3">
              <div className={`p-2 rounded-xl text-white ${
                user?.role === 'admin' ? 'bg-purple-600' : 'bg-[#2c8184]'
              }`}>
        ...
        <section className="px-6 mb-10">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm font-medium text-[#1A202C] focus:ring-2 focus:ring-[#2c8184] focus:border-[#2c8184] transition-all shadow-sm"
                type="text"
                value={nombre}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm font-medium text-[#1A202C] focus:ring-2 focus:ring-[#2c8184] focus:border-[#2c8184] transition-all appearance-none cursor-pointer shadow-sm"
                  value={provincia}
            ...
            <button
              ...
              disabled={guardando}
              className="w-full bg-[#2c8184] text-white font-bold py-3.5 rounded-xl shadow-lg shadow-[#2c8184]/20 active:scale-[0.98] transition-all mt-2 hover:bg-[#2c8184]/90 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <section className="px-6 mb-12">
          ...
          <div className="space-y-3 mb-4">
            <div className="flex items-center justify-between p-4 border border-slate-100 rounded-2xl bg-white shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)]">
              ...
              <button className="text-[#2c8184] text-xs font-bold px-3 py-1 bg-[#2c8184]/5 rounded-lg hover:bg-[#2c8184]/10 transition-colors">
                Editar
              </button>
            </div>
          </div>
          <button className="w-full border-2 border-dashed border-[#2c8184]/30 text-[#2c8184] font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 bg-[#2c8184]/5 hover:bg-[#2c8184]/10 transition-colors">
