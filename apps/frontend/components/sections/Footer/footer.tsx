      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 bg-gray-800 hover:bg-[#2c8184] rounded-lg flex items-center justify-center transition-colors duration-200"
          ...
          <div>
            ...
            <a
              href="/contact"
              className="inline-block px-4 py-2 bg-[#2c8184] hover:bg-[#1e6063] text-white text-sm font-semibold rounded-lg transition-colors"
            >
