...
export default function DonarPage() {
  ...
  // Estado para guardar los datos antes de proceder al pago final
  ...
  // Si la transacción fue creada, mostrar el formulario de Fiserv Connect
          ...
          {paymentMethod === 'connect' && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 text-slate-600 hover:text-slate-900 hover:bg-slate-50 hover:border-slate-300 rounded-full font-medium text-sm transition-all shadow-sm mb-6 group"
              >
                <ArrowLeft className="w-4 h-4 text-slate-400 group-hover:-translate-x-1 transition-transform" /> Cambiar método de pago
              </button>
