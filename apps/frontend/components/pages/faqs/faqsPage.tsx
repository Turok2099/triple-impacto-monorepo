...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Podés elegir el proyecto específico que querés apoyar: educación, salud, vivienda, alimentación, entre otros. Cada proyecto incluye una descripción detallada, objetivos y reportes de impacto. También ofrecemos la opción de que tu donación se distribuya automáticamente según las necesidades más urgentes.",
    icon: Target,
  },
  {
    id: 6,
    ...
    answer:
      "Cada aporte cuenta y genera impacto. Podés elegir entre los montos disponibles para la ONG que quieras apoyar y acceder a beneficios y descuentos desde tu primera donación, independientemente del monto.",
    icon: DollarSign,
  },
  {
    id: 8,
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Todo lo que necesitás saber sobre cómo funciona Club Triple
              Impacto
            </p>
          </div>
