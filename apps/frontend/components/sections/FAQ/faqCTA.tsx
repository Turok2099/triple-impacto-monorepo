      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="/contact"
              className="inline-block px-8 py-4 bg-white text-gray-800 font-semibold text-lg rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 border-2 border-gray-200 hover:border-teal-300"
            >
              Contactar soporte
            </a>
          </div>
