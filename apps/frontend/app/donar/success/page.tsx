    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="flex flex-col items-center max-w-sm text-center">
          <Loader2 className="w-12 h-12 text-[#2c8184] animate-spin mb-6" />
    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
      <div className="max-w-xl w-full">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
          {/* Header */}
          <div className="bg-[#2c8184] p-8 text-center text-white flex flex-col items-center">
          ...
          <div className="p-8">
            ...
            {chargetotal && (
              <div className="mb-8 text-center bg-slate-50 border border-slate-100 rounded-2xl p-6">
                ...
                <div className="flex items-center justify-center text-4xl sm:text-5xl font-black text-[#2c8184] tracking-tight">
            ...
            <div className="bg-[#2c8184]/5 border border-[#2c8184]/10 rounded-xl p-5 mb-8">
              <h2 className="font-bold text-[#2c8184] mb-3 flex items-center gap-2">
                <Gift className="w-5 h-5" /> Beneficios activados
              </h2>
              <div className="text-sm text-slate-700 space-y-2 font-medium">
                <p>• Tu cuenta de beneficios en la red Club Triple Impacto fue enlazada exitosamente</p>
            ...
            <div className="flex flex-col gap-3">
              <Link
                href="/dashboard"
                className="w-full flex items-center justify-center gap-2 py-3.5 px-6 bg-[#2c8184] text-white font-semibold rounded-xl hover:bg-[#128a4a] transition-colors"
              >
      ...
      fallback={
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
          <div className="flex flex-col items-center">
            <Loader2 className="w-12 h-12 text-[#2c8184] animate-spin mb-4" />
